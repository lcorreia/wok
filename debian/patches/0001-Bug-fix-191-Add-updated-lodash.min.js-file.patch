From db862149749ea9eda895f112b29a49bb3e3352cf Mon Sep 17 00:00:00 2001
From: Aline Manera <alinefm@linux.vnet.ibm.com>
Date: Mon, 12 Dec 2016 13:23:16 -0200
Subject: [PATCH 1/2] Bug fix #191: Add updated lodash.min.js file

The lodash.min.js was downloaded from
https://raw.githubusercontent.com/lodash/lodash/4.17.2/dist/lodash.min.js

The non minified version can be found at
https://raw.githubusercontent.com/lodash/lodash/4.17.2/dist/lodash.js

This patch also removes the former lodash.js file and update the HTML
files according to the file name change.
...
index 60ac707..7f42c0f 100644
--- a/.gitignore
+++ b/.gitignore
@@ -24,7 +24,7 @@ contrib/wok.spec.suse
 contrib/make-deb.sh
 docs/wokd.8
 *.min.css
-*.min.js
...
diff --git a/ui/libs/lodash/lodash.js b/ui/libs/lodash/lodash.js
deleted file mode 100644
index 018b6a7..0000000
--- a/ui/libs/lodash/lodash.js
+++ /dev/null
@@ -1,127 +0,0 @@
-/**
- * @license
...
diff --git a/ui/libs/lodash/lodash.min.js b/ui/libs/lodash/lodash.min.js
new file mode 100644
index 0000000..cf2fd3d
--- /dev/null
+++ b/ui/libs/lodash/lodash.min.js
@@ -0,0 +1,136 @@
+/**
+ * @license
+ * Lodash lodash.com/license | Underscore.js 1.8.3 underscorejs.org/LICENSE
...
+    <script src="$href('libs/lodash/lodash.min.js')"></script>
